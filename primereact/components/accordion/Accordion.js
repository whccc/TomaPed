...
var Accordion = /*#__PURE__*/function (_Component2) {
  ...
  _createClass(Accordion, [{
    ...
    value: function renderTabHeader(tab, selected, index) {
      ...
      var iconClassName = (0, _classnames.default)('p-accordion-toggle-icon', (_classNames = {}, _defineProperty(_classNames, "".concat(this.props.expandIcon), !selected), _defineProperty(_classNames, "".concat(this.props.collapseIcon), selected), _classNames));
